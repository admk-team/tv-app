        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <!-- Back Button -->
                    <div class="mb-3">
                        <a href="{{ route('advertiser.banner_ad') }}" class="btn btn-outline-secondary btn-sm"
                            title="Back to All Banner Ads">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>

                    <!-- Heading -->
                    <h4 class="heading mb-4 text-center">Banner Ad Report</h4>
