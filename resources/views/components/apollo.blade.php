...
<body>
    ...
    <header class="content-wrapper d-flex justify-content-between align-items-center px-2 px-md-3 py-2 mb-3">
        <a href="/home">
            <img src="{{ asset('assets/landing_theme_assets/apollo/images/logo.png') }}" class="logo" />
        </a>
    ...
    <div class="tabs position-relative">
        @if (isset($data->app->categories))
            ...
            @foreach ($data->app->categories ?? [] as $category)
                @if (!empty($category->streams) && !empty($category->cat_title))
                    @if ($count < 5)
                        <div class="tab-content px-sm-4 px-md-5 @if ($count == 0) active @endif">
            ...
            <div class="platforms d-flex align-items-center gap-3 gap-md-4 flex-column flex-md-row">
                ...
                <div class="icons">
                    <img src="{{ asset('assets/landing_theme_assets/apollo/images/roku.png') }}"
                        width="66px">
                    <img src="{{ asset('assets/landing_theme_assets/apollo/images/firetv.png') }}"
                        width="66px">
                    <img src="{{ asset('assets/landing_theme_assets/apollo/images/appletv.png') }}"
                        width="66px">
                </div>
            </div>
