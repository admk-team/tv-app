                    ...
                    <div class="channels">
                        ...
                        <div class="chanel-inr">
                            ...
                            @foreach ($channels as $channel)
                                ...
                                @endphp
                                <div class="main-container" style="display: flex; border: 1px solid;background: none; margin-top: 1rem;">
                                    <!-- Channel Information -->
                                            ...
                                            @if (!empty($streams))
                                                ...
                                                @while ($currentStreamStartTime < $endOfSchedule)
                                                    ...
                                                    {{-- <div class="shows"
                                                        ...
                                                        style="
                                                        display: flex; width:{{ $width }}px;margin-left:0.3rem;" class="shadow bg-body-tertiary rounded">
                                                        <div class="tooltip">
                                                            <a
