...
<style>
    .our_storycard {
        background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6)),
            url("http://127.0.0.1:8000/storage/images/landing_page/Unlimitedmovies,TVshowsandmore._2024-05-02_08-47-46.jpg");
    }
</style>
...
<body>
    ...
    <div class="our_storycard">
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 text-center">
            ...
            <div
                ...
                <h1 class="cards_headtitles"><span>Unlimited</span> Movies <h4>and TV show</h4>
                </h1>
                <p class="leadinsttiltes">
                    Escape into a realm of movies, TV series, documentaries, and beyond. From heart-pounding thrillers
                    to heartwarming dramas, find it all on 24 Flix.
                </p>
            </div>
        </div>
        <div class="row d-flex align-items-center justify-content-center m-auto text-white py-3">
            <div class="col-md-6">
                <div class=" row d-flex align-items-center justify-content-center gap-3 flex-column mb-7">
                    <div class="col-md-12">
                        <h4 class="text-center text-white membership_dec"> <span>Ready to watch?</span> Enter your email
                            to create or restart your membership.</h4>
                    </div>
                    <div class="col-md-12">
        ...
        <div class="apps__links mt-5">
            <h5 style="display: inline-block">Download Now</h5>
    ...
    <!-- END: Hero Section -->
    <!-- starts: App stores Section -->
    <div class="sec-video d-flex flex-column justify-content-center align-items-center text-center mb-5">
        <div class="col-8 mx-auto">
            <h1><span>Stream</span> Anywhere</h1>
            <p>You can find 24 Flix on all of the major App Stores including IOS, Android, Roku, Apple TV, Amazon Fire TV, Samsung, LG, Vidaa and on the web.</p>
        </div>
        <div class="col-12 mx-auto gap-1 mt-2 py-5 owl-carousel stream-icons">
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/roku.png" class="me-3" width="50px">
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/apple.png" class="me-3" width="50px">
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/roku.png" class="me-3" width="50px">
            {{--  <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/appletv.png" class="me-3" width="50px">  --}}
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/firetv.png" class="me-3" width="50px">
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/firetv.png" class="me-3" width="50px">
            {{--  <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/appletv.png" width="50px">  --}}
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/roku.png" class="me-3" width="50px">
            <img src="http://localhost:4000/assets/landing_theme_assets/lyra/images/firetv.png" class="me-3" width="50px">
        </div>      
    </div>
    <div class="sec-device tab-content active-device d-flex flex-column justify-content-center align-items-center text-center d-none">
        <div class="col-8 mx-auto">
            <h1>Enjoy on your<span> Television.</span> </h1>
            <p>Watch on smart TVs, Chromecast, Apple TV, Blu-ray players and more.</p>
        </div>
    </div>
    <div class="sec-device tab-content d-flex flex-column justify-content-center align-items-center text-center d-none" >
        <div class="col-8 mx-auto">
            <h1>Enjoy on your<span> Tablet & Mobile.</span> </h1>
            <p>Watch on smartphones, tablets, and other mobile devices.</p>
        </div>
    </div>
    <div class="sec-device tab-content d-flex flex-column justify-content-center align-items-center text-center d-none" >
        <div class="col-8 mx-auto">
            <h1>Enjoy on your<span> Desktop & Laptop.</span> </h1>
            <p>Watch on desktop computers, laptops, and more.</p>
        </div>
    </div>
    ...
    <div class="container mt-3 active-device d-none tab-image" style="background-color: rgba(255, 255, 255, 0.048)">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <img src="http://127.0.0.1:8000/storage/images/landing_page/Unlimitedmovies,TVshowsandmore._2024-05-02_08-47-46.jpg" class="img-fluid" alt="TV Image">
            </div>
        </div>
    </div>
    <div class="container mt-3 d-none tab-image" style="background-color: rgba(255, 255, 255, 0.048)" >
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <img src="http://127.0.0.1:8000/storage/images/landing_page/Unlimitedmovies,TVshowsandmore._2024-05-02_08-47-46.jpg" class="img-fluid" alt="Tablet & Mobile Image">
            </div>
        </div>
    </div>
    <div class="container mt-3 d-none tab-image" style="background-color: rgba(255, 255, 255, 0.048)">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <img src="http://127.0.0.1:8000/storage/images/landing_page/Unlimitedmovies,TVshowsandmore._2024-05-02_08-47-46.jpg" class="img-fluid" alt="Desktop & Laptop Image">
            </div>
        </div>
    </div>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne{{$loop->index}}" class="accordion-collapse collapse"
                                ...
                                data-bs-parent="#accordionFlushExample" style="background: grey;">
        ...
        <div class="row d-flex align-items-center justify-content-center m-auto text-white py-5">
            <div class="col-md-6">
                <div class="tv__icons row d-flex align-items-center justify-content-center gap-3 flex-column mb-3">
                    <div class="col-md-12">
                        <h4 class="text-center"> Ready to watch? Enter your email to create or restart your membership.
                        </h4>
                    </div>
                    <form id="form">
                        <div class="col-md-12">
    ...
    <script>
        $(document).ready(function(){
            var owl = $('.owl-carousel').owlCarousel({
                ...
                autoplayTimeout: 3000, // Initial autoplay interval in milliseconds
