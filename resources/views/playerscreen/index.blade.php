...
@section('content')
    ...
    $ratingsCount = isset($arrSlctItemData['ratings']) && is_array($arrSlctItemData['ratings']) 
    ? count($arrSlctItemData['ratings']) 
    : 0;
    ?>
        ...
        @if (
            ...
            <div id="reviews" class="content d-none"><!--Start of Ratings section-->
                <div class="item-ratings">
                    <h1 class="section-title">Reviews: ({{ $ratingsCount ?? 0 }})</h1>
                    @php
