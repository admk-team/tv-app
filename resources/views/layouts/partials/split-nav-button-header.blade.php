                ...
                <li class="nav-item">
                    <div class="dropdown dropdin">
                        ...
                        <ul class="dropdown_menus profiledropin avtartMenu" style="display: none;">
                            ...
                            @endif
                            @if (isset(session('USER_DETAILS')['ACCOUNT_TYPE']) && session('USER_DETAILS')['ACCOUNT_TYPE'] == 'AD')
                                <li><a class="text-decoration-none" href="{{ route('advertiser.overlay_ad') }}">Overlay
                                        Ads</a>
                                </li>
                            @endif
                            @if (isset(session('USER_DETAILS')['ACCOUNT_TYPE']) && session('USER_DETAILS')['ACCOUNT_TYPE'] == 'AD')
                                <li><a class="text-decoration-none" href="{{ route('advertiser.banner_ad') }}">Banner
                                        Ads</a>
                                </li>
                            @endif
                            @if (isset(session('USER_DETAILS')['ACCOUNT_TYPE']) && session('USER_DETAILS')['ACCOUNT_TYPE'] == 'AD')
                    ...
                    @if (!empty($menu->for_group_user))
                        ...
                        @if (session()->has('USER_DETAILS.GROUP_USER') && !empty(session('USER_DETAILS.GROUP_USER')))
                            ...
                            @if (!empty($commonGroups))
                                ...
                                <a class="text-decoration-none header-text border-hover"
                                    href="/{{ $menu->menu_slug }}">
                    ...
                    <li class="nav-item">
                        <div class="dropdown dropdin">
                            ...
                            <ul class="dropdown_menus profiledropin avtartMenu gap-0"
                                ...
                                @if (isset(session('USER_DETAILS')['ACCOUNT_TYPE']) && session('USER_DETAILS')['ACCOUNT_TYPE'] == 'AD')
                                    <li><a class="text-decoration-none"
                                            href="{{ route('advertiser.video_ad') }}">Video
                                            Ads</a>
                                    </li>
                                @endif
                                {{-- <li><a class="text-decoration-none" href="{{ route('password.edit') }}">Change
