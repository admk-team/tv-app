<nav class="navbar">
    <div class="container-fluid position-relative  d-flex align-items-center justify-content-between m-auto">
        <div class="py-3 my-2">
            <a href="/">
        ...
        <div class="side-header">
            <header class="pt-4 pb-3 d-flex align-items-center justify-content-center flex-column">
                <nav class="inner d-flex align-items-center justify-content-around gap-5 mb-4">
