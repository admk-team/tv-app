...
<section class="credential_form signForm"> 
    <div class="login_page main_pg">
        ...
        <div class="inner-cred">
            ...
            @endif
            <form method="POST" name='registeration_form' id="registerationForm" action="{{ route('register') }}" class="cred_form"> 
                @csrf
                <div class="row">
                        ...
                        <div class="inner-div dv23">
                            ...
                            <input type="hidden" name="">
                                <div class="social_space" style="display:none;">
                                    <a class="btn_facebook" id="quickstart-sign-in" href=""><i class="fa fa-facebook"></i> Login with Facebook</a>
                                </div>
                                <div class="social_space" style="display:none;">
                                    <a class="btn_twitter" href=""><i class="fa fa-twitter"></i> Login with Twitter</a>
                                </div>
                        ...
                        <div class="inner-div dv2">                        
                            <div class="input_groupbox">
                                <label class="contact-label">
                                    ...
                                    <input id="name" type="text" class="form-control " placeholder="Name" name="name" value="" autocomplete="name" autofocus="">
                            ...
                            <div class="input_groupbox">
                                <label class="contact-label">
                                    <div class="vertLine"></div>
                                    <input id="email" type="email" class="form-control " placeholder="Email" name="email" value="" autocomplete="email" autofocus="">
                            ...
                            <div class="input_groupbox">
                                <label class="contact-label">
                                    ...
                                    <img src="{{ asset('assets/images/lock.png') }}" class="icn"> 
                                    <span id="eye_password" toggle="#cpassword" class="fa fa-light fa-eye field-icon toggle-password2" style="display:none;"></span> 
                                </label>
                            ...
                            <div class="form-group mb-4">
                                <button class="btn" class="submit">SUBMIT</button>                             
                            </div>
                            <div class="input_groupbox alreadyText">
                                <p class="fw-medium">Already have an account ? <a href="/signin">Click here to Login</a></p>
                            </div>
                        </div>
                    </div>
                </div>
